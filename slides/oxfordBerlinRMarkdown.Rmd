...
Slides for this workshop:<br> [ulyngs.github.io/UPDATE-THIS](https://ulyngs.github.io/rmarkdown-workshop-2019/)

Materials for this workshop:<br> [github.com/ulyngs/UPDATE-THIS](https://github.com/ulyngs/rmarkdown-workshop-2019)

Band art by [Allison Horst](https://github.com/allisonhorst/stats-illustrations)
]

]

???
- I'm Ulrik, and I'll speaking about how to use R Markdown to make reproducible research easy and fun!
...
- fan of open science, think R Markdown's got a things stuff going for it; wrote my entire phd thesis in it and use it for everything from basic data analysis to interactive dashboards and even a songbook for my live karaoke band
...
4. report a calculation with inline code 
]
...
.col-4.beginner[
1. Use the Visual Editor to insert a reference into an R Markdown document - knit to see the result
2. Make cross-references to a figure and a table
]
  
.col-4.intermediate[
1. Try adding a custom label to a header and use this label to reference the section
...
2. Try downloading a **.csl** file with a citation style from [zotero.org/styles](https://www.zotero.org/styles). Try using this to style the references when you knit your R Markdown document (in the YAML header, use `csl: the-file-you-downloaded.csl`)
]
